...
class Button extends Component {
  ...
  _onPressIn = (evt) => {
    let ripple = this.refs.container;
    ripple && ripple.showRipple();
    this.props.onPressIn && this.props.onPressIn(evt);
  }

  _onPressOut = (evt) => {
    let ripple = this.refs.container;
    ripple && ripple.hideRipple();
    this.props.onPressOut && this.props.onPressOut(evt);
  }
